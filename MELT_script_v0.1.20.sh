...
mkdir project/003_MSc_MEI_detection/benchmarking_output/"$1"_2

# Move output files to the output directory
mv scratch/*.vcf project/003_MSc_MEI_detection/benchmarking_output/"$1"_2/
mv scratch/*.list project/003_MSc_MEI_detection/benchmarking_output/"$1"_2/
mv scratch/*.tsv project/003_MSc_MEI_detection/benchmarking_output/"$1"_2/
mv scratch/*final* project/003_MSc_MEI_detection/benchmarking_output/"$1"_2/
